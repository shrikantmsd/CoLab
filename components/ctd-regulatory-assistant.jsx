...
<!-- Generated by CoLAB Regulatory Affairs Assistant -->
...
<ich-ectd-index version="3.2.2">
  <header>
    ...
    <generated-by>CoLAB v1.0 - CTD/eCTD Regulatory Affairs Assistant</generated-by>
  </header>
  <ich-ectd>
    <!-- Module 1: Administrative -->
    <m1>
...
function UploadZone({ onFiles }) {
  ...
  return <div onDragOver={(e) => { e.preventDefault(); setDragging(true); }}
    ...
    <div style={{ color: THEME.text, fontWeight: 600, marginBottom: 4 }}>Drop regulatory documents into CoLAB</div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="15" y="30" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="7" fill="#ffffff" letterSpacing="0.3">CoLAB</text>
            ...
            <div style={{ animation: "fadeIn 0.3s ease", display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                ...
                <Card>
                  ...
                  {dossier ? (
                    <div style={{ display: "flex", gap: 8 }}>
                      <DownloadButton content={dossier.manifestCSV} filename="colab-manifest.csv" label="manifest.csv" />
          ...
          {activeTab === "import" && (
            <div style={{ animation: "fadeIn 0.3s ease", maxWidth: 860 }}>
              <Card style={{ marginBottom: 16 }}>
                <SectionTitle sub="Import eCTD sequences, legacy dossiers, or structured data packages into CoLAB">
                  Import
                </SectionTitle>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  ...
                  <div style={{ background: THEME.surfaceAlt, border: `1px solid ${THEME.border}`, borderRadius: 4, padding: 14 }}>
                    ...
                    <div style={{ fontSize: 11, color: THEME.textMuted, lineHeight: 1.6, marginBottom: 12 }}>
                      Import a zipped eCTD sequence folder (with index.xml backbone). CoLAB will parse the structure, extract metadata, and populate the dossier tree.
                    </div>
                  ...
                  <div style={{ background: THEME.surfaceAlt, border: `1px solid ${THEME.border}`, borderRadius: 4, padding: 14 }}>
                    ...
                    <div style={{ fontSize: 11, color: THEME.textMuted, lineHeight: 1.6, marginBottom: 12 }}>
                      Import a LORENZ docuBridge .dbx or manifest CSV. CoLAB will reconstruct the eCTD structure and populate the sequence history.
                    </div>
                    <div style={{ border: `2px dashed ${THEME.border}`, borderRadius: 4, padding: "18px 12px", textAlign: "center", cursor: "pointer", color: THEME.textMuted, fontSize: 11, background: "#fff" }}
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                      <div>
                        <p style={{ margin: "0 0 14px", fontSize: 13, color: THEME.textMuted, lineHeight: 1.6 }}>
                          Upload a change control document, deviation report, or process change description. CoLAB will cross-reference it against your EC Register and determine the required regulatory action.
                        </p>
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 11, color: THEME.textMuted }}>
                    AI-powered regulatory & QA compliance review · CoLAB Intelligence Engine
...
function generateFolderScript(docs, appInfo) {
  ...
  dirs.add(`${base}/stf`);
  return `#!/bin/bash\n# CoLAB eCTD folder structure — compatible with LORENZ docuBridge & EXTEDO eCTDmanager\n# Application: ${appInfo.appNumber || "NDA000000"} | Sequence: ${seq} | Region: ${appInfo.country || "US"}\n\n` +
...
<envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="3.2.2">
  ...
  <submission>
    <submission-type>${appInfo.subType || "NDA"}</submission-type>
    <sequence-description>Initial submission generated by CoLAB v1.0</sequence-description>
    <ectd-version>3.2.2</ectd-version>
    <generated-by>CoLAB — CTD/eCTD Regulatory Affairs Assistant</generated-by>
...
function generateExtedoAttributes(docs, appInfo) {
  ...
  const summaries = [
    `"m2/23-quality-overall-summary/quality-overall-summary.pdf","Quality Overall Summary (Module 2.3)","Quality Summary","new","","","","","","","","","","","m2/23-quality-overall-summary","${appInfo.country || "US"}","${appInfo.appNumber || "NDA000000"}","${(appInfo.sequence||"0000").padStart(4,"0")}","CoLAB v1.0"`,
    `"m2/24-nonclinical-overview/nonclinical-overview.pdf","Nonclinical Overview (Module 2.4)","Nonclinical Overview","new","","","","","","","","","","","m2/24-nonclinical-overview","${appInfo.country || "US"}","${appInfo.appNumber || "NDA000000"}","${(appInfo.sequence||"0000").padStart(4,"0")}","CoLAB v1.0"`,
    `"m2/25-clinical-overview/clinical-overview.pdf","Clinical Overview (Module 2.5)","Clinical Overview","new","","","","","","","","","","","m2/25-clinical-overview","${appInfo.country || "US"}","${appInfo.appNumber || "NDA000000"}","${(appInfo.sequence||"0000").padStart(4,"0")}","CoLAB v1.0"`,
  ];
  return header + rows.join("\n") + (rows.length ? "\n" : "") + summaries.join("\n");
}
